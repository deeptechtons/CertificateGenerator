...
namespace Pluralsight.Crypto.UI
{
    ...
    {
        private X509Certificate2Collection _selectedCertificates;
        ...
        private void btnSaveToCertStore_Click(object sender, EventArgs e)
        {
            ...
            {
                errorProvider.SetError(btnSaveToCertStore, ex.Message);
            }
        }
